...
const Chunk = () => {
    return (
        <div className="border-b py-5">
            ...
            <div className="flex">
                <input type="number" id="size" defaultValue={"512"} className="h-9 mt-2 outline-none w-[200px] rounded px-2 border focus:border-blue-400 focus:shadow focus:shadow-blue-300"/>
